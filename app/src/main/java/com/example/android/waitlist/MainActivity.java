...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewGuestNameEditText = (EditText) mNewGuestNameEditText.findViewById(R.id.person_name_edit_text);
        mNewPartySizeEditText = (EditText) mNewPartySizeEditText.findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        try{
            ...
            Log.e(LOG_TAG,"Failed to parse String to int",e);
        ...
        String gestName = mNewGuestNameEditText.getText().toString();
        long newRowID = addGuest(gestName, partySize);
    ...
    public long addGuest (String guestName, int partySize){
        ...
        // CREATE CV to save date

        ContentValues cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME,guestName);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE,partySize);

        long newRowId = mDb.insert(WaitlistContract.WaitlistEntry.TABLE_NAME,null,cv);
